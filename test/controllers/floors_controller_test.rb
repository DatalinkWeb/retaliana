...
class FloorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create floor" do
    assert_difference('Floor.count') do
      post floors_url, params: { floor: { description: @floor.description, name: @floor.name, photo_url: @floor.photo_url, price: @floor.price, quantity: @floor.quantity } }
    end
  ...
  test "should update floor" do
    patch floor_url(@floor), params: { floor: { description: @floor.description, name: @floor.name, photo_url: @floor.photo_url, price: @floor.price, quantity: @floor.quantity } }
